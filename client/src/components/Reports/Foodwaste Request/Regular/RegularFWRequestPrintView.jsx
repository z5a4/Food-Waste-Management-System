...
import { Modal, Button, Typography } from '@material-tailwind/react';

const RegularFWPrintView = ({ data, onClose }) => {
  return (
      <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white p-8 rounded-lg shadow-lg print:p-0 print:shadow-none print:bg-transparent print:w-full print:max-w-screen-lg max-h-full overflow-y-auto">
          <Typography variant="h5" className="text-center mb-4">Regular FW Request Details</Typography>
          <div className="mb-4">
...
export default RegularFWPrintView;
