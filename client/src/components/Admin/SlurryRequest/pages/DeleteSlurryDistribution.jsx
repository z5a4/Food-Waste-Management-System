...
import { useDeleteSlurryDistribution } from '../functions/useDeleteSlurryDistribution'; // Import the custom hook
...
const DeleteSlurryDistribution = () => {
  ...
  return (
    <div className="container mt-5 pt-5">
      <Typography color="blueGray" variant="h1" className="text-center">Delete Slurry Distribution</Typography>
      {loading ? (
          ...
          <table className="table table-bordered w-3/4 mx-auto">
            <tbody className='text-center'>
              ...
              <tr>
                ...
                <th><Input variant='standard' type="date" name="submissionDate" value={formData.submissionDate.split('T')[0]} readOnly /></th>
              </tr>
              <tr>
                <th colSpan="2" className="text-center">
                  <Button color="red" size="lg" type="submit">Delete</Button>
                </th>
              </tr>
              <tr>
                <th colSpan="2" className="text-center">
