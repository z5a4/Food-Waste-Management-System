...
import UseruseAddSlurryDistributionForm from '../functions/UseruseAddSlurryDistributionForm';
import UserNavbar from '../../UserNavbar';
import Footer from '../../../Footer/Footer';

function UserAddSlurryDistributionForm() {
  const { id } = useParams();
  const { slurryRequest, loading, error, handleChange, handleSubmit, successMessage } = UseruseAddSlurryDistributionForm(id);
...
export default UserAddSlurryDistributionForm;
